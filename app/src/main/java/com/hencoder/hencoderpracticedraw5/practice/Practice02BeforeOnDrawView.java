...
public class Practice02BeforeOnDrawView extends AppCompatTextView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        bounds.left = layout.getLineLeft(lineCount - 3);
        bounds.right = layout.getLineRight(lineCount - 4);
        bounds.top = layout.getLineTop(lineCount - 3);
        bounds.bottom = layout.getLineBottom(lineCount - 2);
        canvas.drawRect(bounds, paint);
